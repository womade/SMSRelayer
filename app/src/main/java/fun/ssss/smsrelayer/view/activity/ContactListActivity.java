package fun.ssss.smsrelayer.view.activity;
...
import fun.ssss.smsrelayer.view.adapter.ContactListAdapter;
import fun.ssss.smsrelayer.view.adapter.decoration.ContactDecoration;
import fun.ssss.smsrelayer.data.bean.Contact;
import fun.ssss.smsrelayer.data.Constants;
import fun.ssss.smsrelayer.utils.ContactManager;
